...
const MosqueDirectory = () => {
  ...
  const mosqueData = [
    { 
      id: 1, 
      name: 'ষ্টেশন মসজিদ', 
      location: 'ষ্টেশন সংলগ্ন, শমশেরনগর বাজার', 
      type: 'জামে মসজিদ',
      stats: {
        capacity: '১২০০ জন',
        established: '১৯৫০',
    ...
    { 
      id: 2, 
      name: 'বিতর বাজার বাইতুল মামুর জামে মনজিদ', 
      location: 'ভিতর বাজার, শমশেরনগর', 
      type: 'জামে মসজিদ',
      stats: {
        capacity: '৮০০ জন',
        established: '১৯৮৫',
        khatib: 'মাওলানা আব্দুল হাই',
        muazzin: 'কারী জয়নাল আবেদীন'
      },
      facilities: ['আধুনিক এসি সুবিধা', 'পার্কিং ব্যবস্থা', 'বিশাল মিনার'],
      history: 'বিমানবাহিনী ও স্থানীয় জনগণের সমন্বয়ে নির্মিত এই মসজিদটি তার স্থাপত্যশৈলীর জন্য পরিচিত।',
      mapUrl: 'https://www.google.com/maps',
  ...
  return (
    <div className="min-h-screen px-0 mb-10">
      ...
      <div className="bg-emerald-800 p-10 px-2 text-center rounded-lg m-3">
        ...
        <h1 className="text-3xl md:text-5xl font-black text-white uppercase tracking-tight">মসজিদ ডিরেক্টরি</h1>
